...
def main():
    ...
    service_parser = subparsers.add_parser(
        "client", help="Call service operations"
    )
    ...
    service_parser.add_argument(
        "--service-json",
        required=False,
        help="Path to service definition JSON",
    )

    translate_parser = subparsers.add_parser(
        "translate", help="Translate topology JSON"
    )
    translate_parser.add_argument(
        "--topology-json", required=True, help="Path to topology JSON"
    )
    translate_parser.add_argument(
        "--schema", required=True, help="Path to JSON schema"
    )
